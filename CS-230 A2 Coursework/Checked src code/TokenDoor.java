...
public class TokenDoor extends Door {
	...
	/**
	 * The constructor for the Token Door object.
	 * @param x The x Position of the Token Door on the map
	 * @param y The y Position of the Token Door on the map
	 * @param gc
	 * @param TILE_SIZE Sets the size of the tile
	 * @param requirements The number of Tokens that it takes to open the door.
	 */
